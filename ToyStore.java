...
public class ToyStore {
    ...
    public void getPrizeToy_file() throws IOException {
        if (prizeToys.size() > 0) {
            ...
            writer.write("Toy ID  №: " + prizeToy.getId() + ", Toy name: " + prizeToy.getName() + "\n");
            writer.close();
            System.out.println("Toy ID  №: " + prizeToy.getId() + ", Toy name: " + prizeToy.getName());
        }
    }
